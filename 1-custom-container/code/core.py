...
def train(model, optimizer, train_batches, test_batches, epochs, 
    ...
    for epoch in range(epochs):
        ...
        print_output = 'epoch_num:{} , train_loss:{} , train_acc:{} , test_loss:{} , test_acc:{}'
        print(print_output.format(epoch, epoch_stats['train loss'], epoch_stats['train acc'], epoch_stats['test loss'], epoch_stats['test acc']))
