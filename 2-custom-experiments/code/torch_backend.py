...
def cifar10(train_dataset, eval_dataset):
    train_set = torchvision.datasets.CIFAR10(root=train_dataset, train=True, download=True)
    test_set = torchvision.datasets.CIFAR10(root=eval_dataset, train=False, download=True)
    return {
